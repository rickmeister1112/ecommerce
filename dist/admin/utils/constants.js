...
exports.messages = exports.rupify = exports.cashfree = exports.genHeaders = exports.defaults = exports.apis = exports.zoho = void 0;
exports.zoho = {
...
exports.defaults = {
    bnplQualifyDuration: 3 * 31 * 24 * 60 * 60 * 1000
};
exports.genHeaders = {
...
exports.cashfree = {
    authHeaders: Object.assign({ "x-api-version": "2022-09-01", "x-client-id": process.env.cashfree_client_id, "x-client-secret": process.env.cashfree_client_secret }, exports.genHeaders),
};
exports.rupify = {
    authHeaders: Object.assign({ "x-rpf-key": process.env.rupify_api_key }, exports.genHeaders)
};
exports.messages = {
    ...
    rupifyStatus: (statusText) => {
        try {
            ...
            txt = txt.split(", ")[1];
            txt = txt.split("=")[1];
            return exports.messages.approvedCredit(txt);
        }
        catch (error) {
            console.error(error);
            return statusText;
